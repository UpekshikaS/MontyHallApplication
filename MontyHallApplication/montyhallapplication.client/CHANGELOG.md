...
- Create Angular project with ng: `ng new montyhallapplication.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`montyhallapplication.client.esproj`).
